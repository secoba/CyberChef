...
class App {
  ...
  confirm (title, body, accept, reject, callback, scope) {
    ...
    $('#confirm-modal').modal().one('show.bs.modal', function (e) {
      this.confirmClosed = false
    }.bind(this)).one('click', '#confirm-yes', function () {
      this.confirmClosed = true
      callback.bind(scope)(true)
      $('#confirm-modal').modal('hide')
    }.bind(this)).one('click', '#confirm-no', function () {
      this.confirmClosed = true
      callback.bind(scope)(false)
    }.bind(this)).one('hide.bs.modal', function (e) {
